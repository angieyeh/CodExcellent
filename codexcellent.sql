...
--
-- Host: localhost
-- Generation Time: Aug 09, 2022 at 04:49 AM
...
INSERT INTO `Certificates` (`certificate_id`, `certificate_title`, `issue_date`, `student_enrollment_id`) VALUES
(1, 'Certificate of Completion', '2022-03-17', 1),
(2, 'Certificate of Completion', '2023-06-17', 4),
(3, 'Certificate of Completion', '2023-06-17', 5);
...
(5, 'Jack Sheridan', 'jack_sheridan@gmail.com', NULL, 'He/him/his', 'Mentor'),
(6, 'Alex Roberts', 'alexroberts@yahoo.com', '2091236534', NULL, 'Mentor');
...
INSERT INTO `Students` (`student_id`, `name`, `email`, `phone_number`, `pronoun`, `tutor_id`) VALUES
(1, 'Chloe Decker', 'chloedecker@gmail.com', '2025550108', 'She/her/her', NULL),
(2, 'Ella Lopez', 'ellalopez@gmail.com', '2025550185', 'She/her/her', 1),
(3, 'Dan Espinoza', 'danespinoza@gmail.com', '2025550114', 'He/him/his', 2),
(4, 'Rory Gilmore', 'rorygilmore@gmail.com', '2025555514', NULL, 2),
(5, 'Mel Monroe', 'melmonroe@yahoo.com', NULL, 'She/her/her', 4);
...
INSERT INTO `Student_Enrollments` (`student_enrollment_id`, `student_id`, `course_id`, `is_enrolled`) VALUES
(1, 1, 1, 1),
(2, 2, 1, 0),
(3, 1, 3, 0),
(4, 2, 2, 1),
...
--
ALTER TABLE `Student_Enrollments`
  MODIFY `student_enrollment_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Certificates`
  ADD CONSTRAINT `student_enrollment_id` FOREIGN KEY (`student_enrollment_id`) REFERENCES `Student_Enrollments` (`student_enrollment_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
